...
class Controller_Admin_Catalogo_Marcas extends Controller_Admin
{
	...
	public function action_index($search = '')
	{
		...
		if (!Helper_Permission::can('catalogo_marcas', 'view')) {
			#SI NO TIENE PERMISO SE DA EL ERROR
			Session::set_flash('error', 'No tienes permiso para ver marcas.');
	...
	public function action_agregar()
	{
		...
		if (!Helper_Permission::can('catalogo_marcas', 'create')) {
			Session::set_flash('error', 'No tienes permiso para crear marcas.');
			Response::redirect('admin/catalogo/marcas');	
    	}
	...
	public function action_editar($brand_id = 0)
	{
		...
		if (!Helper_Permission::can('catalogo_marcas', 'edit')) {
        	Session::set_flash('error', 'No tienes permiso para editar marcas.');
        	Response::redirect('admin/catalogo/marcas');
    	}
	...
	public function action_eliminar($brand_id = 0)
	{
		...
		if (!Helper_Permission::can('catalogo_marcas', 'delete')) {
        	Session::set_flash('error', 'No tienes permiso para eliminar marcas.');
        	Response::redirect('admin/catalogo/marcas');
    	}
