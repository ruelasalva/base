...
/**
 * Controlador para módulo: integracion_instagram
 * Redirige a vista de módulo en desarrollo
 */
class Controller_Admin_integracioninstagram extends Controller_Admin_Base
{
    public function action_index()
    {
        ...
        $module_info = DB::select('display_name', 'icon', 'category')
            ->from('modules')
            ->where('name', 'integracion_instagram')
            ->execute()
            ->current();
