...
/**
 * Controlador para módulo: integracion_mercadolibre
 * Redirige a vista de módulo en desarrollo
 */
class Controller_Admin_integracionmercadolibre extends Controller_Admin_Base
{
    public function action_index()
    {
        ...
        $module_info = DB::select('display_name', 'icon', 'category')
            ->from('modules')
            ->where('name', 'integracion_mercadolibre')
            ->execute()
            ->current();
