...
/**
 * Controlador para módulo: integracion_woocommerce
 * Redirige a vista de módulo en desarrollo
 */
class Controller_Admin_integracionwoocommerce extends Controller_Admin_Base
{
    public function action_index()
    {
        ...
        $module_info = DB::select('display_name', 'icon', 'category')
            ->from('modules')
            ->where('name', 'integracion_woocommerce')
            ->execute()
            ->current();
