...
class Controller_Admin_Polizas extends Controller_Admin
{
	public function action_index()
	{
		...
		{
			Session::set_flash('error', 'No tienes permisos para ver pólizas contables');
		...
		$data['content'] = '<div class="container-fluid p-4"><h1>Módulo Pólizas Contables</h1><p>En desarrollo...</p></div>';
