...
class Model_Partners_Address extends \Orm\Model
{
    ...
    {
        $response = Model_Partners_Address::query();
    ...
    {
        $response = new Model_Partners_Address($request);
    ...
    {
        $response = Model_Partners_Address::find($id);
	...
	protected static $_table_name = 'partners_addresses';
