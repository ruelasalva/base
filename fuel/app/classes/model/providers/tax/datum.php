...
class Model_Providers_Tax_Datum extends \Orm\Model
{
    ...
    {
        $response = Model_Providers_Tax_Datum::query();
    ...
    {
        $response = new Model_Providers_Tax_Datum($request);
    ...
    {
        $response = Model_Providers_Tax_Datum::find($id);
	...
	protected static $_table_name = 'providers_tax_data';
