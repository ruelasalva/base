					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/abandonados/editar/'.$id, 'Editar'); ?>
							</li>
						</ol>
					</nav>
				</div>
				<div class="col-lg-6 col-5 text-right">
					<?php echo Html::anchor('admin/abandonados/info/'.$id, 'Ver', array('class' => 'btn btn-sm btn-neutral')); ?>
					<?php if($bill_id == 0): ?>
					...
					<?php endif; ?>
					<?php if ($type_id == 2): ?>	
						<?php //echo Html::anchor('admin/abandonados/editar_voucher/'.$id, 'Modificar Comprobante', array('class' => 'btn btn-sm btn-neutral')); ?>
					<?php endif; ?>
				</div>
			</div>
		</div>
					...
					<?php echo Form::open(array('method' => 'post')); ?>
						<fieldset>
							<div class="form-row">
								...
								<div class="col-md-6 mb-3">
									<div class="form-group">
										<?php echo Form::label('Id de Transación', 'transaction', array('class' => 'form-control-label', 'for' => 'transaction')); ?>
										<?php echo Form::input('transaction', (isset($transaction) ? $transaction : ''), array('id' => 'transaction', 'class' => 'form-control '.$classes['transaction']['form-control'], 'placeholder' => 'ID Transacion')); ?>
										<?php if(isset($errors['transaction'])) : ?>
											<div class="invalid-feedback">
												<?php echo $errors['transaction']; ?>
											</div>
										<?php endif; ?>
									</div>
								</div>
