					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/blog/publicaciones/editar/'.$id, 'Editar'); ?>
							</li>
						</ol>
					</nav>
				</div>
				<div class="col-lg-6 col-5 text-right">
					<?php echo Html::anchor('admin/blog/publicaciones/info/'.$id, 'Ver', array('class' => 'btn btn-sm btn-neutral')); ?>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<?php echo Form::open(array('method' => 'post')); ?>
							...
							<?php echo Form::submit(array('value'=> 'Editar', 'name'=>'submit', 'id' => 'add-post', 'class' => 'btn btn-primary submit-form')); ?>
						<?php echo Form::close(); ?>
					</div>
				</div>
			</div>
