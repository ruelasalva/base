<?php /* Vista editar.php para Descuentos */ ?>
<!-- CONTENT -->
        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <?php echo Html::anchor('admin/catalogo/generales/descuentos/editar/'.$id, 'Editar', array('class' => 'btn btn-sm btn-neutral')); ?>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <span class="form-control"><?php echo $structure; ?></span>
                                    </div>
                                </div>
                                <!-- Tipo -->
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <?php echo Form::label('Porcentaje efectivo final', 'final_effective', array('class' => 'form-control-label')); ?>
                                        <span class="form-control"><?php echo $final_effective !== null ? number_format($final_effective, 2) : '-'; ?></span>
                                    </div>
                                </div>
                                <!-- Creado en -->
                                <div class="col-md-6 mb-3">
