        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Agregar Unidad</h6>
                </div>
...
<div class="container-fluid mt--6">
    ...
    <div class="card">
        <div class="card-header"><h3 class="mb-0">Nueva Unidad (Interna)</h3></div>
        <div class="card-body">
            <?php echo Form::open(); ?>
            ...
            <div class="form-group mt-2">
                ...
                <small class="text-muted">Origen: <span class="badge badge-info">Interna</span></small>
            </div>
