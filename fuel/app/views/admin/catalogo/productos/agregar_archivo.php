					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/catalogo/productos/agregar_foto/'.$id, 'Agregar archivo'); ?>
							</li>
						</ol>
					</nav>
				</div>
			...
			<div class="card-wrapper">
				...
				<div class="card">
					...
					<div class="card-header">
						<h3 class="mb-0">Agregar archivo</h3>
					</div>
					<!-- CARD BODY -->
					<div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group <?php echo $classes['file']['form-group'] ?? ''; ?>">
                                        ...
                                        <?php echo Form::hidden('file', (isset($file) ? $file : ''), array('id' => 'file-hidden', 'class' => 'form-control '.($classes['file']['form-control'] ?? ''))); ?>
                        ...
                        <?php echo Form::submit(array('value'=> 'Agregar archivo', 'name'=>'submit', 'class' => 'btn btn-primary submit-form')); ?>
                        <?php echo Form::close(); ?>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (fileInput) {
            fileInput.addEventListener('change', function(e) {
                ...
                fileLabel.textContent = fileName ? fileName : 'Seleccionar PDF';

                // Actualiza la previsualización con el icono y nombre
                if (pdfPreview) {
                    pdfPreview.innerHTML = '<div class="dz-pdf-icon text-center mt-2">' +
                        '<i class="fa fa-file-pdf-o fa-3x text-danger"></i><br>' +
                        '<span class="dz-preview-filename">' + (fileName ? fileName : 'No hay archivo PDF') + '</span>' +
                        '</div>';
                }
            });
        }
