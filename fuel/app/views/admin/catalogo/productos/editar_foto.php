					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/catalogo/productos/editar_foto/'.$id, 'Editar foto'); ?>
							</li>
						</ol>
					</nav>
				</div>
				<div class="col-lg-4 col-5 text-right">
					<?php echo Html::anchor('admin/catalogo/productos/info_foto/'.$id, 'Ver foto', array('class' => 'btn btn-sm btn-neutral')); ?>
				</div>
			</div>
		</div>
	</div>
									...
									<div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['image']['form-group']; ?>">
											...
											<div class="dropzone dropzone-single dz-clickable dz-max-files-reached"
												data-toggle="dropzone-img"
												data-dropzone-url="<?php echo Uri::create('admin/ajax/product_image'); ?>"
												data-id="image"
												data-width="640"
												data-height="640"
												data-last-file="<?php echo (isset($image)) ? $image : ''; ?>">
												<div class="fallback">
												...
												<div class="dz-preview dz-preview-single">
													<div class="dz-preview-cover dz-processing dz-image-preview dz-complete">
														<?php
															// LÓGICA: MUESTRA IMAGEN REAL SI EXISTE, SINO LA ESTÁNDAR
															if (isset($image) && $image != '' && file_exists(DOCROOT.'assets/uploads/'.$image)) {
