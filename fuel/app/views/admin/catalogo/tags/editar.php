				...
				<div class="col-lg-6 col-7">
					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item">
								<?php echo Html::anchor('admin/catalogo/tags', 'Etiqueta'); ?>
							</li>
							<li class="breadcrumb-item">
								<?php echo Html::anchor('admin/catalogo/tags/info/'.$id, $name); ?>
							</li>
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/catalogo/tags/editar/'.$id, 'Editar'); ?>
							</li>
						</ol>
					</nav>
				</div>
				<div class="col-lg-6 col-5 text-right">
					<?php echo Html::anchor('admin/catalogo/tags/info/'.$id, 'Ver', array('class' => 'btn btn-sm btn-neutral')); ?>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<?php echo Form::open(array('method' => 'post')); ?>
									...
									<div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['image']['form-group']; ?>">
											...
											<?php if(isset($image) && $image != ''): ?>
												<div class="dropzone dropzone-single dz-clickable dz-max-files-reached" data-toggle="dropzone-img" data-dropzone-url="<?php echo Uri::create('admin/ajax/image'); ?>" data-id="image" data-width="202" data-height="86" data-last-file="<?php echo (isset($image)) ? $image : ''; ?>">
													<div class="fallback">
											...
											<?php else: ?>
												<div class="dropzone dropzone-single" data-toggle="dropzone-img" data-dropzone-url="<?php echo Uri::create('admin/ajax/image'); ?>" data-id="image" data-width="202" data-height="86" data-last-file="<?php echo (isset($image)) ? $image : ''; ?>">
													<div class="fallback">
														<div class="custom-file">
															<?php echo Form::file('image', array('class' => 'custom-file-input', 'id' => 'image')); ?>
															<label class="custom-file-label" for="image">Seleccionar archivo</label>
							...
							<?php echo Form::submit(array('value'=> 'Guardar', 'name'=>'submit', 'class' => 'btn btn-primary submit-form')); ?> <!--modificado sajor -->
						<?php echo Form::close(); ?>
					</div>
				</div>
			</div>
