		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				<div class="col-lg-6 col-7">
					<h6 class="h2 text-white d-inline-block mb-0">Correos - Agregar Plantilla</h6>
		...
		<div class="col">
			<div class="card">
				<div class="card-header">
					<h3 class="mb-0">Nueva Plantilla</h3>
				</div>
				<div class="card-body">
					<?php echo Form::open(['method'=>'post']); ?>
						...
						<div class="form-group <?= $classes['code']['form-group'] ?>">
							...
							<?php echo Form::input('code',$code,['class'=>'form-control '.$classes['code']['form-control'],'placeholder'=>'ej: venta_confirmacion_user']); ?>
						...
						<div class="form-group <?= $classes['role']['form-group'] ?>">
							...
							<?php echo Form::input('role',$role,['class'=>'form-control '.$classes['role']['form-control'],'placeholder'=>'ej: ventas']); ?>
						...
						<div class="form-group <?= $classes['view']['form-group'] ?>">
							...
							<?php echo Form::input('view',$view,['class'=>'form-control '.$classes['view']['form-control'],'placeholder'=>'ej: emails/ventas/user']); ?>
