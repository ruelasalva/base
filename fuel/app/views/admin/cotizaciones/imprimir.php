    ...
    <tbody>
        <?php foreach ($quote->products as $product): ?>
            <tr>
                ...
                <td>$<?php echo number_format($product->total / $product->quantity, 2); ?></td>
                <td>$<?php echo number_format($product->total, 2); ?></td>
                <td>$<?php echo number_format($product->total * 1.16, 2); ?></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
...
<div class="footer">
    ...
    <div class="firma">
        ...
        <p><strong>Nombre, firma y fecha de aceptación:</strong></p>
    </div>
</div>
