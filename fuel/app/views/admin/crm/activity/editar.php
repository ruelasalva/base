					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/crm/task/activity', 'Editar'); ?>
							</li>
						</ol>
					</nav>
				</div>
			...
			<div class="card-wrapper">
				<div class="card">
					...
					<div class="card-header d-flex justify-content-between align-items-center">
						<h3 class="mb-0">Editar actividades para CRM <strong>Num. <?php echo $act_num; ?></strong></h3>
					...
					<?php if($completed == 0): ?>
						...
						<div class="card-body">
							...
							<div class="form-group text-right">
								<button id="add-activity" type="button" class="btn btn-primary" data-actnum="<?php echo $act_num; ?>" data-edit="1">Agregar</button>
								<button id="edit-activity" type="button" class="btn btn-primary" data-activity-id="" style="display: none">Editar</button>
									...
									<?php if(!empty($activities)): ?>
										<?php foreach($activities as $activity): ?>
											<tr>
												...
												<?php if($completed == 0): ?>
													<td><?php echo Html::anchor('#', 'Editar', array('title' => 'Guardar', 'class' => 'activity-edit', 'data-activity-id' => $activity['id'])); ?></td>
												<?php endif; ?>
											</tr>
										<?php endforeach; ?>
									<?php endif; ?>
