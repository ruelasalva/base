					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/crm/task', 'Pendientes'); ?>
							</li>
						</ol>
					</nav>
				</div>
		...
		<div class="col">
			<div class="card">
				...
				<div class="card-header border-0">
					<?php echo Form::open(array('action' => 'admin/crm/task/buscar', 'method' => 'post')); ?>
					<div class="form-row">
						<div class="col-md-9">
						...
						<tbody class="list">
							<?php if(!empty($tasks)): ?>
								<?php foreach($tasks as $task): ?>
									<tr>
                                        <th class="id">
											<?php echo Html::anchor('admin/crm/task/info/'.$task['id'], $task['id']); ?>
										</th>
                                        <th class="created_at">
										...
										<td class="text-right">
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
													<?php echo Html::anchor('admin/crm/task/info/'.$task['id'], 'Ver', array('class' => 'dropdown-item')); ?>
													<?php echo Html::anchor('admin/crm/task/editar/'.$task['id'], 'Editar', array('class' => 'dropdown-item')); ?>
													<?php echo Html::anchor('admin/crm/task/cancelar/'.$task['id'], 'Cancelar', array('class' => 'dropdown-item')); ?>
												</div>
											</div>
										</td>
									</tr>
