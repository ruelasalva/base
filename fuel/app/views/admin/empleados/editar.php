                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/empleados/editar/'.$id, 'Editar'); ?>
							</li>
						</ol>
					</nav>
				</div>
                <div class="col-lg-6 col-5 text-right">
					<?php echo Html::anchor('admin/empleados/info/'.$id, 'Ver', array('class' => 'btn btn-sm btn-neutral')); ?>
				</div>
			</div>
		</div>
	</div>
								...
								<div class="form-row">
									...
									<div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['department_id']['form-group']; ?>">
											<?php echo Form::label('Departamento', 'deparment_id', array('class' => 'form-control-label', 'for' => 'department_id')); ?>
											<?php echo Form::select('department_id', Input::post('department_id', isset($department_id) ? $department_id : 'none'), $department_opts, array('id' => 'department_id', 'class' => 'form-control '.$classes['department_id']['form-control'], 'data-toggle' => 'select')); ?>
									...
									<div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['email']['form-group']; ?>">
											...
											<?php echo Form::input('email', (isset($email) ? $email : ''), array('id' => 'email', 'class' => 'form-control '.$classes['email']['form-control'], 'placeholder' => 'Correo Electronico')); ?>
									...
									<div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['codigo']['form-group']; ?>">
											<?php echo Form::label('Código de Empleado', 'codigo', array('class' => 'form-control-label', 'for' => 'codigo')); ?>
									...
									<div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['code_seller']['form-group']; ?>">
											<?php echo Form::label('Código de Vendedor', 'code_seller', array('class' => 'form-control-label', 'for' => 'code_seller')); ?>
								...
								<div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['email_user']['form-group']; ?>">
											<?php echo Form::label('Email Usuario', 'email_user', array('class' => 'form-control-label', 'for' => 'email_user')); ?>
											<?php echo Form::input('email_user', (isset($email_user) ? $email_user : ''), array('id' => 'email_user', 'class' => 'form-control '.$classes['email_user']['form-control'], 'placeholder' => 'Email User')); ?>
