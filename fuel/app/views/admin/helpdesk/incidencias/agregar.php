					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/helpdesk/incident/agregar', 'Agregar'); ?>
							</li>
						</ol>
					</nav>
				</div>
						...
						<fieldset>
							<div class="form-row">
							    ...
							    <div class="form-group <?php echo $classes['type_id']['form-group']; ?>">
							        <?php echo Form::label('Tipo de incidente', 'type_id', array('class' => 'form-control-label', 'for' => 'type_id')); ?>
								...
								<div class="col-6 mb-3">
									<div class="form-group <?php echo $classes['name']['form-group']; ?>">
										<?php echo Form::label('Descripción', 'name', array('class' => 'form-control-label', 'for' => 'name')); ?>
										<?php echo Form::textarea('name', (isset($name) ? $name : ''), array('id' => 'name', 'class' => 'form-control '.$classes['name']['form-control'], 'placeholder' => 'Descripción', 'rows' => 2)); ?>
