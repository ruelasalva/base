							...
							<div class="form-row">
                                <div class="col-md-6 mb-3">
									<div class="form-group">
										<?php echo Form::label('Usuario', 'name', array('class' => 'form-control-label', 'for' => 'name')); ?>
										<span class="form-control"><?php echo $user_id; ?></span>
									</div>
								</div>
                                <div class="col-md-6 mb-3">
									<div class="form-group">
										<?php echo Form::label('Descripción del problema', 'name', array('class' => 'form-control-label', 'for' => 'name')); ?>
                                ...
                                <div class="col-md-6 mb-3">
									<div class="form-group">
										<?php echo Form::label('Fecha finalización:', 'name', array('class' => 'form-control-label', 'for' => 'name')); ?>
