					...
					<div class="card-body" style="padding: 1.5rem;">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" 
										   ...
										   value="<?php echo Input::post('code', $product->code); ?>" 
										   required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" 
										   ...
										   class="form-control" 
										   style="border: 1px solid #d1d5db;"
										   value="<?php echo Input::post('barcode', $product->barcode); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<textarea name="description" 
									  class="form-control" 
									  style="border: 1px solid #d1d5db;"
									  rows="4"><?php echo Input::post('description', $product->description); ?></textarea>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<?php echo Form::select('category_id', Input::post('category_id', $product->category_id), $categories, array('class' => 'form-control', 'style' => 'border: 1px solid #d1d5db;')); ?>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label style="color: #374151; font-weight: 500;">Unidad de Medida <span class="text-danger">*</span></label>
									<?php echo Form::select('unit_of_measure', Input::post('unit_of_measure', $product->unit_of_measure), $units, array('class' => 'form-control', 'style' => 'border: 1px solid #d1d5db;', 'required' => 'required')); ?>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="number" 
											   ...
											   step="0.01" 
											   min="0" 
											   value="<?php echo Input::post('unit_price', $product->unit_price); ?>" 
											   required>
									</div>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="number" 
											   ...
											   step="0.01" 
											   min="0" 
											   value="<?php echo Input::post('cost', $product->cost); ?>" 
											   required>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" 
										   ...
										   min="0" 
										   max="100" 
										   value="<?php echo Input::post('tax_rate', $product->tax_rate); ?>">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card-body" style="padding: 1.5rem;">
						<div class="form-group">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" 
									   ...
									   name="is_service" 
									   value="1" 
									   <?php echo Input::post('is_service', $product->is_service) ? 'checked' : ''; ?>>
						...
						<div id="stock_fields">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label style="color: #374151; font-weight: 500;">Stock Actual</label>
										<input type="number" 
											   name="stock" 
											   class="form-control" 
											   style="border: 1px solid #d1d5db;"
											   step="0.01" 
											   min="0" 
											   value="<?php echo Input::post('stock', $product->stock); ?>">
										<small class="text-muted">
											<a href="<?php echo Uri::create('admin/inventory/products/adjust_stock/' . $product->id); ?>">
												Usar ajuste de inventario
											</a>
										</small>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="number" 
											   ...
											   step="0.01" 
											   min="0" 
											   value="<?php echo Input::post('min_stock', $product->min_stock); ?>">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="number" 
											   ...
											   step="0.01" 
											   min="0" 
											   value="<?php echo Input::post('max_stock', $product->max_stock); ?>">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group mb-0">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" 
									   ...
									   name="is_active" 
									   value="1" 
									   <?php echo Input::post('is_active', $product->is_active) ? 'checked' : ''; ?>>
