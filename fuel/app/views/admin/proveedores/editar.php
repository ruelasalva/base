				...
				<div class="col-lg-6 col-7">
					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item">
								<?php echo Html::anchor('admin/proveedores/info/'.$id, $name); ?>
							</li>
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo Html::anchor('admin/proveedores/editar/'.$id, 'Editar'); ?>
							</li>
						</ol>
					</nav>
				</div>
				<div class="col-lg-6 col-5 text-right">
					<?php echo Html::anchor('admin/proveedores/info/'.$id, 'Ver', array('class' => 'btn btn-sm btn-neutral')); ?>
				</div>
			</div>
		</div>
	</div>
							...
							<fieldset>
								<div class="form-row">
									<div class="col-md-12 mt-0 mb-3">
										<legend class="mb-0 heading">Información del Proveedores</legend>
									</div>
								...
								<div class="form-row">
									...
									<div class="col-md-6 mb-3">
										<div class="form-group <?php echo $classes['require_purchase']['form-group']; ?>">
											...
											<?php echo Form::select('require_purchase', (isset($require_purchase) ? $require_purchase : 0), array('0' => 'No','1' => 'Sí'), array('id' => 'require_purchase', 'class' => 'form-control '.$classes['require_purchase']['form-control'], 'data-toggle' => 'select'));	?>
