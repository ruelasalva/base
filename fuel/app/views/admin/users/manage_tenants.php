<div class="card">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="<?php echo Uri::create('admin/users/view/' . $user->id); ?>" class="btn btn-sm btn-secondary">
	...
	<div class="card-body">
		...
		<form action="<?php echo Uri::create('admin/users/update_user_tenants'); ?>" method="post">
...
function assignAllTenants(userId) {
	...
	$.ajax({
		url: '<?php echo Uri::create('admin/users/assign_all_tenants'); ?>',
		type: 'POST',
		data: {
			user_id: userId,
