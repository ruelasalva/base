...
<div class="row mb-4">
	<div class="col-md-12">
		<div class="d-flex justify-content-between align-items-center">
			<div>
				<h2 class="mb-1"><i class="fas fa-user-plus me-2"></i>Nuevo Usuario</h2>
				<p class="text-muted mb-0">Crea un nuevo usuario y asígnale roles</p>
			</div>
			<div>
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-6 mb-3">
							...
							<small class="text-muted">Correo electrónico del usuario</small>
						</div>
					</div>
