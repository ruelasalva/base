		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<?php echo Html::anchor('admin/ventas/agregar_venta', 'Nueva', array('class' => 'btn btn-sm btn-neutral')); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col">
			<div class="card">
				...
				<!-- LIGHT TABLE -->
				<div class="table-responsive" data-toggle="lists" data-list-values='["id", "customer", "email", "type", "total", "status", "sale_date", "order"]'>
