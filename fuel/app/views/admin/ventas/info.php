		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-7 text-right">
					...
					<?php echo Html::anchor('admin/ventas/reenviar_correo/'.$id, 'Reenviar Correo', array('class' => 'btn btn-sm btn-neutral')); ?>
					<?php echo Html::anchor('admin/ventas/asignar_facturacion/'.$id, 'Asignar datos de facturación', array('class' => 'btn btn-sm btn-neutral')); ?>
					<?php if($bill_id == 0): ?>
					...
					<?php endif; ?>
					<?php if($status == 2): ?>
						<?php echo Html::anchor('admin/ventas/agregar_voucher/'.$id,'Subir Comprobante', array('class' => 'btn btn-sm btn-neutral')); ?>
