	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">Información del Usuario #<?php echo htmlspecialchars($user_id, ENT_QUOTES, 'UTF-8'); ?></h3>
			</div>
			<div class="panel-body">
				<form method="post" action="<?php echo Uri::base(); ?>admin/users/actualizar/<?php echo htmlspecialchars($user_id, ENT_QUOTES, 'UTF-8'); ?>">
					<div class="row">
						<div class="col-md-6">
