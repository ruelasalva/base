...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span class="glyphicon glyphicon-time"></span> Pedidos Recientes</h3>
			</div>
			<div class="panel-body">
				<p class="text-muted text-center"><em>No hay pedidos recientes para mostrar.</em></p>
			</div>
		</div>
	</div>
</div>
