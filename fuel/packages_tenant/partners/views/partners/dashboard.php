		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6">
						<a href="<?php echo Uri::base() . htmlspecialchars($link['url'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-default btn-lg btn-block" style="margin-bottom: 10px; background: #9b59b6; color: white; border-color: #8e44ad;">
