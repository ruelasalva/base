	...
	<div class="col-md-8">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<form method="post" action="<?php echo Uri::base(); ?>sellers/sales/crear">
					<div class="form-group">
						...
						<p class="help-block">
							<a href="<?php echo Uri::base(); ?>sellers/customers/agregar" target="_blank">
					...
					<table class="table table-bordered" id="productos-table">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" class="form-control" name="precios[]" value="0.00" readonly></td>
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="notas" name="notas" rows="2" placeholder="Notas adicionales..."></textarea>
					</div>
					<hr>
					<div class="form-group">
						<button type="submit" class="btn btn-info">
							<span class="glyphicon glyphicon-ok"></span> Registrar Venta
						</button>
						<a href="<?php echo Uri::base(); ?>sellers/sales" class="btn btn-default">
